...
//                            System.out.println(positionToken[1]);
    ...
    private static void checkWin(int row, int col, String[][] table4, String playerPiece) {
        ...
        checkDiagonal(row, col, table4, playerPiece);
    }

    private static void checkDiagonal(int row, int col, String[][] table4, String playerPiece) {

        int tokenGoodRight = 1;
        int tokenGoodleft = 1;
//        System.out.println(row + " " + col);
        for(int g = 1; g < 7; g++){
//            System.out.println((row + g )+ " " + (col + g));
            if ((row - g >= 0 && row - g <= 6 ) && (col - g > 0 && col - g <= 7)) {
//                System.out.println((row - g) + " " + (col + g) + " " + table4[row - g][col + g]);
                System.out.println(row + " " + col);
                if (table4[row - g][col - g].equals(playerPiece)) {
                    tokenGoodleft++;
...
//            System.out.println("L " + tokenGoodleft);
//            System.out.println("R" + tokenGoodRight);

            if (tokenGoodleft == 4){
                win = true;
                break;

            }else if(tokenGoodRight == 4){
                win = true;
                break;
            }
